...
#url = 'https://sampo.thl.fi/pivot/prod/fi/ttr/shp/fact_shp.json?row=area-128940&column=time-129350&filter=reportgroup-12465&filter=measure-73008'
...
#url = 'https://sampo.thl.fi/pivot/prod/fi/ttr/shp/fact_shp.dimensions.json


#header = {'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/50.0.2661.102 Safari/537.36'}

#r = requests.get(url, headers=header)
#hep = r.content.decode()
#%%
#dimensions = pd.read_json(r.content.decode(), encoding='latin1', skiprows=2)
#dimensions = pd.read_json(hep, encoding='latin1', orient='records')
#print(dimensions['dataset']['value']['0'])
...
#Parse week id from
#https://sampo.thl.fi/pivot/prod/fi/ttr/shp/fact_shp.dimensions.json